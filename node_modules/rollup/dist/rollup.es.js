/*
	Rollup.js v0.38.3
	Thu Dec 29 2016 09:04:22 GMT-0500 (EST) - commit f8a09fd0bd576a37ae3c5147c6502e5701b151d9
		...
		if ( this.shouldInclude || this.declaration.activated ) {
			if ( this.declaration.type === 'CallExpression' && this.declaration.callee.type === 'FunctionExpression' && this.declaration.arguments.length ) {
				...
				if ( !isWrapped ) {
					...
					if ( newlineSeparated ) {
						var ref = getLocation( this.module.code, this.declaration.start );
						var line = ref.line;
	...
	return this.resolveId( this.entry, undefined )
		...
		.then( function (entryModule) {
			...
			this$1.externalModules.forEach( function (module) {
				...
				this$1.onwarn( (names + " imported from external module '" + (module.id) + "' but never used") );
			});
		...
		return ( resolvedId ? Promise.resolve( resolvedId ) : this$1.resolveId( source, module.id ) )
			.then( function (resolvedId) {
				...
				if ( !resolvedId && !isExternal ) {
					...
					this$1.onwarn( ("'" + source + "' is imported by " + (relativeId( module.id )) + ", but could not be resolved – treating it as an external dependency. For help see https://github.com/rollup/rollup/wiki/Troubleshooting#treating-module-as-external-dependency") );
					isExternal = true;
				}
